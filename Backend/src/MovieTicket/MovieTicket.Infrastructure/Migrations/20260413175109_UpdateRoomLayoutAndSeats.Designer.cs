...
namespace MovieTicket.Infrastructure.Migrations
{
    ...
    [Migration("20260413175109_UpdateRoomLayoutAndSeats")]
    partial class UpdateRoomLayoutAndSeats
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieTicket.Domain.Entities.CinemaHallSeat", b =>
                {
                    ...
                    b.HasIndex(new[] { "HallId", "RowSeat", "ColSeat" }, "UQ_Hall_Row_Col")
                        .IsUnique()
                        .HasFilter("[HallID] IS NOT NULL AND [row_seat] IS NOT NULL AND [col_seat] IS NOT NULL");
            ...
            modelBuilder.Entity("MovieTicket.Domain.Entities.RoomLayout", b =>
                {
                    ...
                    b.HasIndex(new[] { "HallId", "RowSeat", "ColSeat" }, "UQ_RoomLayout_Position")
                        .IsUnique();
